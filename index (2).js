...
mm.setNickname("Slayer runs me")
            ...
            if (command === 'help') {
                ...
                let helpEmbed = new Discord.RichEmbed()
                    ...
                    .addField("help nuke", "```Shows Nuke Commands```", true)
                    .addField("help misc", "```Shows Misc Commands```", true)
                    .addField("help fun", "```Shows Fun Commands```", true)
                    .addField('help utility', '```Shows Utility Commands```', true)
                    .addField("help status", "```Shows Status Commands```", true)
